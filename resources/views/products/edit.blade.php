...
<div class="max-w-2xl space-y-5">
    <form method="POST" action="{{ route('products.update', $product) }}" enctype="multipart/form-data" class="space-y-5">
        ...
        <div class="card p-6 space-y-5">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" name="unit" value="{{ old('unit', $product->unit) }}" class="input" list="unit-list" required>
                        ...
                        <div class="flex items-center gap-6 pt-1">
                            <label class="flex items-center gap-2 cursor-pointer">
                                <input type="radio" name="type" value="product" 
                                    @checked(old('type', $product->type) === 'product')
                            ...
                            <label class="flex items-center gap-2 cursor-pointer">
                                <input type="radio" name="type" value="service" 
                                    @checked(old('type', $product->type) === 'service')
                                    class="rounded border-slate-700 bg-slate-800 text-green-500">
        ...
        <div class="card p-6 space-y-4" x-data="{ type: '{{ $product->type }}' }">
            ...
            <div x-show="type === 'service'" x-cloak class="text-slate-400 text-sm italic p-4 text-center">Services have no stock.</div>
        </div>
